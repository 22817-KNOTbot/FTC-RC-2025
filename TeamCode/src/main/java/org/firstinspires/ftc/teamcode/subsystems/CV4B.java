...
public class CV4B {
	 ...
	 * Coax: Higher = back
	 */
	public static double TRANSFER_DRIVE = 0.64;
	public static double TRANSFER_COAX = 0.783;
	...
	public static double SPECIMEN_HANG_DRIVE = 0.78;
	public static double SPECIMEN_HANG_COAX = 0.898;
