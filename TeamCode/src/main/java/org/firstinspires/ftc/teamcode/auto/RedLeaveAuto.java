...
@Configurable
@Autonomous(name = "Lower Red Leave", group = "Autonomous")
public class RedLeaveAuto extends LinearOpMode {
	...
	public void runOpMode() {
		Object blackboardObject = blackboard.getOrDefault(POSE, new Pose(84.000, 8.000));
		blackboard.put(ALLIANCE, alliance);
		blackboard.put(POSE, new Pose(84.000, 8.000));
